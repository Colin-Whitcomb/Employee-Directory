...
function sortFirstName(Arr) {
    Arr.sort(GetSortOrder("firstName")); //Pass the attribute to be sorted on       
    for (var item in Arr) {
...
function sortLastName(Arr) {
    Arr.sort(GetSortOrder("lastName")); //Pass the attribute to be sorted on       
    for (var item in Arr) {
        console.log(JSON.stringify(Arr[item].lastName));
    }
}

sortLastName(employArr);